...
const EditableElementOverlay = ({ id, isSideBarItem = false }: Props) => {
  ...
  return (
    <li
      style={style}
      className="p-4 opacity-60 rounded-md text-xl text-center border border-dashed border-gray-400 hover:border-black hover:opacity-100 cursor-pointer bg-white"
    >
